...
public class LogParser implements IPQuery, UserQuery, DateQuery, EventQuery, QLQuery {
    private Path logDir;
    private List<com.javarush.task.task39.task3913.LogParser.LogEntity> logEntities = new ArrayList<>();
                ...
                if (file.toString().toLowerCase().endsWith(".log")) {
                    try (BufferedReader reader = new BufferedReader(new FileReader(file.toFile()))) {
                        ...
                        while ((line = reader.readLine()) != null) {
                            ...
                            com.javarush.task.task39.task3913.LogParser.LogEntity logEntity = new com.javarush.task.task39.task3913.LogParser.LogEntity(ip, user, date, event, eventAdditionalParameter, status);
    ...
    private Object getCurrentValue(com.javarush.task.task39.task3913.LogParser.LogEntity logEntity, String field) {
        Object value = null;
        switch (field) {
            case "ip": {
                com.javarush.task.task39.task3913.LogParser.Command method = new com.javarush.task.task39.task3913.LogParser.GetIpCommand(logEntity);
                value = method.execute();
                break;
            }
            case "user": {
                com.javarush.task.task39.task3913.LogParser.Command method = new com.javarush.task.task39.task3913.LogParser.GetUserCommand(logEntity);
                value = method.execute();
                break;
            }
            case "date": {
                com.javarush.task.task39.task3913.LogParser.Command method = new com.javarush.task.task39.task3913.LogParser.GetDateCommand(logEntity);
                value = method.execute();
                break;
            }
            case "event": {
                com.javarush.task.task39.task3913.LogParser.Command method = new com.javarush.task.task39.task3913.LogParser.GetEventCommand(logEntity);
                value = method.execute();
                break;
            }
            case "status": {
                com.javarush.task.task39.task3913.LogParser.Command method = new com.javarush.task.task39.task3913.LogParser.GetStatusCommand(logEntity);
                value = method.execute();
                break;
            }
        }
    ...
    private abstract class Command {
        protected com.javarush.task.task39.task3913.LogParser.LogEntity logEntity;

        abstract Object execute();
    }

    private class GetIpCommand extends com.javarush.task.task39.task3913.LogParser.Command {
        public GetIpCommand(com.javarush.task.task39.task3913.LogParser.LogEntity logEntity) {
    ...
    private class GetUserCommand extends com.javarush.task.task39.task3913.LogParser.Command {
        public GetUserCommand(com.javarush.task.task39.task3913.LogParser.LogEntity logEntity) {
            this.logEntity = logEntity;
        }
    ...
    private class GetDateCommand extends com.javarush.task.task39.task3913.LogParser.Command {
        public GetDateCommand(com.javarush.task.task39.task3913.LogParser.LogEntity logEntity) {
            this.logEntity = logEntity;
        }
    ...
    private class GetEventCommand extends com.javarush.task.task39.task3913.LogParser.Command {
        public GetEventCommand(com.javarush.task.task39.task3913.LogParser.LogEntity logEntity) {
            this.logEntity = logEntity;
        }
    ...
    private class GetStatusCommand extends com.javarush.task.task39.task3913.LogParser.Command {
        public GetStatusCommand(com.javarush.task.task39.task3913.LogParser.LogEntity logEntity) {
            this.logEntity = logEntity;
        }
