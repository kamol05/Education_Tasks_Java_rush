...
public class test {
    ...
    public static void sort(List<Stock> list) {
        list.sort(new Comparator<Stock>() {
            public int compare(Stock stock11, Stock stock22) {
                int compare;
                return (compare = compareName(stock11, stock22)) != 0 ? compare
                        : (compare = compareDate(stock11, stock22)) != 0 ? compare
                        : compareProfit(stock11, stock22);
            }
            ...
            private int compareDate(test.Stock stock1, test.Stock stock2) {
    ...
    public static List<Stock> getStocks() {
        ...
        stocks.add(new test.Stock("JAVARUSH", "TEST", 666.66, 777.79));
        stocks.add(new test.Stock("JAVARUSH", "TEST", 666.66, 111.78));
        stocks.add(new test.Stock("JAVARUSH", "TEST", 666.66, -0.01));
        Date d = new Date(); d.setDate(6); Date d1 = new Date(); d1.setDate(7);
        stocks.add(new test.Stock("JAVARUSH", "TEST", .7, d));
        stocks.add(new test.Stock("JAVARUSH", "TEST", .7, d1));
